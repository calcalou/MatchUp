...
function AdminEquipe(props) {
  ...
  return (
    <View style={styles.container}>
        ...
        <Text style={styles.Title}>Panneau Admin EQUIPE</Text>
        
        <View style={styles.TextButtonContainer}>
            <TouchableOpacity>
                <Text style={styles.TextButton}>Modifier le nom de l'équipe</Text>
            </TouchableOpacity>
            
            <TouchableOpacity>
                <Text style={styles.TextButton}>Modifier le logo de l'équipe</Text>
            </TouchableOpacity>

            <TouchableOpacity>
                <Text style={styles.TextButton}>Modifier la description de l'équipe</Text>
            </TouchableOpacity>

            <TouchableOpacity>
                <Text style={styles.TextButton}>Modifier la localisation de l'équipe</Text>
            </TouchableOpacity>

            <TouchableOpacity>
                <Text style={styles.TextButton}>Supprimer un joueur de l'équipe</Text>
            </TouchableOpacity>

            <TouchableOpacity>
                <Text style={styles.TextButton}>Modifier les droits joueurs de l'équipe</Text>
            </TouchableOpacity>

            <TouchableOpacity>
                <Text style={styles.TextButton}>Dissoudre l'équipe</Text>
            </TouchableOpacity>

            <TouchableOpacity>
                <Text style={styles.TextButton}>Réactiver l'équipe</Text>
            </TouchableOpacity>
        </View>
    </View>
  );
